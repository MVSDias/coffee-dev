    ...
    <div className="flex flex-1 flex-col md:flex-row md:justify-center mx-10 mt-18 md:mt-4 lg:mt-0 items-center h-screen">
      <div className="object-fit">
        <div className="mb-6 lg:mb-3">
          <h1 className="w-full text-nowrap text-[#5f3403] font-bold text-xl sm:text-3xl md:text-2xl sm:mt-10 md:mt-10  lg:-mt-4 lg:text-2xl">
        ...
        <div>
          <div className="flex items-center gap-4 mb-4 lg:mb-2">
            <MapPinLineIcon  className=" p-2 md:p-1 text-white bg-amber-500 rounded-full text-3xl md:text-[28px]" />
          ...
          <div className="flex items-center gap-4 mb-4 lg:mb-2">
            <ClockIcon className=" p-2 md:p-1 text-white bg-amber-500 rounded-full text-3xl md:text-[28px]" />
            <div className="">
          ...
          <div className="flex items-center gap-4 mb-4 lg:mb-0">
            <CurrencyDollarIcon className=" p-2 md:p-1 text-white bg-amber-500 rounded-full text-3xl md:text-[28px]" />
            <div className="">
      ...
      <div className="md:mb-3  pt-18 md:ml-10 lg:p-2 ">
